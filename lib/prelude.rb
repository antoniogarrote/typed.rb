...
module Enumerable
  ...
  ts '#chunk / BasicObject -> &([T] -> BasicObject -> Boolean) -> Enumerator[Pair[Boolean][Array[T]]]'
  ...
  ts '#max_by / &([T] -> BasicObject) -> [T]'
  ts '#max_by / Integer -> &([T] -> BasicObject) -> Array[T]'
  ...
  ts '#min_by / &([T] -> BasicObject) -> [T]'
  ts '#min_by / Integer -> &([T] -> BasicObject) -> Array[T]'
  ts '#min_by / -> Enumerator[T]'
  ts '#min_by / Integer -> Enumerator[T]'
  ts '#minmax / -> Pair[T][T]'
  ts '#minmax / &(Pair[T][T] -> Integer) -> Pair[T][T]'
  ts '#minmax_by / &([T] -> BasicObject) -> Pair[T][T]'
  ...
  ts '#reverse_each / BasicObject... -> Enumerator[T]'
  ts '#reverse_each / BasicObject... -> &([T] -> unit) -> Enumerator[T]'
  ...
  ts '#to_a / BasicObject... -> Array[T]'
  #   ts '#to_h / BasicObject... -> Hash'
...
class String
  ...
  ts '#== / BasicObject -> Boolean'
  ts '#=== / BasicObject -> Boolean'
  ts '#=~ / BasicObject -> Integer'
  ts '#[] / BasicObject -> String'
  ts '#[] / BasicObject -> BasicObject -> String'
  ts '#ascii_only? / -> Boolean'
  ts  '#b / -> String'
  ts '#bytes / -> Array[Integer]'
  ts '#bytesize / -> Integer'
  ts '#byteslice / BasicObject -> String'
  ...
  ts '#empty? / -> Boolean'
  ts '#encode / BasicObject... -> String'
  ts '#encode! / BasicObject -> BasicObject... -> String'
  ...
  ts '#gsub / Regexp -> BasicObject -> String'
  ts '#gsub! / Regexp -> Enumerator[String]'
  ts '#gsub! / Regexp -> &(String -> String) -> String'
  ts '#gsub! / Regexp -> BasicObject -> String'
  ts '#hash / -> Fixnum'
  ...
  ts '#index / BasicObject -> Fixnum'
  ts '#index / BasicObject -> Integer -> Fixnum'
  ...
  ts '#oct / -> Integer'
  ts '#ord / -> Integer'
  ts '#partition / BasicObject -> Array[String]'
  ts '#prepend / String -> String'
  ts '#replace / String -> String'
  ts '#reverse / -> String'
  ts '#reverse! / -> String'
  ts '#rindex / BasicObject -> Fixnum'
  ts '#rindex / BasicObject -> Integer -> Fixnum'
  ts '#rjust / Integer -> String'
  ts '#rjust / Integer -> String -> String'
  ts '#rpartition / BasicObject -> Array[String]'
  ts '#rstrip / -> String'
  ts '#rstrip! / -> String'
  ...
  ts '#size / -> Integer'
  ts '#slice / BasicObject -> String'
  ts '#slice / BasicObject -> BasicObject -> String'
  ts '#slice! / BasicObject -> String'
  ts '#slice! / BasicObject -> BasicObject -> String'
  ts '#split / BasicObject -> Array[String]'
  ts '#split / BasicObject -> Integer -> Array[String]'
  ...
  ts '#sub / Regexp -> BasicObject -> String'
  ts '#sub! / Regexp -> Enumerator[String]'
  ts '#sub! / Regexp -> &(String -> String) -> String'
  ts '#sub! / Regexp -> BasicObject -> String'
  ts '#succ / -> String'
