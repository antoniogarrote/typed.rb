...
describe TypedRb::Languages::PolyFeatherweightRuby::Types::TypingContext do
  ...
  describe '.type_variable_for' do
    ...
    it 'should register and find an instance variable for a ruby type' do
      ...
      expect(result).to be_a(TypedRb::Languages::PolyFeatherweightRuby::Types::Polymorphism::TypeVariable)
