...
describe TypedRb::Languages::PolyFeatherweightRuby::Parser do
  ...
  context '#parse' do
    it 'should parse a class statement' do
      ...
      expect(parsed.body).to be_instance_of(TypedRb::Languages::PolyFeatherweightRuby::Model::TmInt)
    end
    ...
    it 'should parse definition of functions' do
      ...
      expect(parsed).to be_instance_of(TypedRb::Languages::PolyFeatherweightRuby::Model::TmFun)
    ...
    it 'should parse definition of functions with optional args' do
      ...
      expect(parsed.args[1].last).to be_instance_of(TypedRb::Languages::PolyFeatherweightRuby::Model::TmInt)
      expect(parsed.body.to_s).to be == 'x'
      expect(parsed.owner).to be_nil
    end
    ...
    it 'should parse the use of instance variables' do
      parsed = parse('@a')
      expect(parsed).to be_instance_of(TypedRb::Languages::PolyFeatherweightRuby::Model::TmInstanceVar)
      expect(parsed.val).to be == :@a
    end

    it 'should parse instance variable assginations' do
      parsed = parse('@a = 3')
      expect(parsed).to be_instance_of(TypedRb::Languages::PolyFeatherweightRuby::Model::TmInstanceVarAssignment)
      expect(parsed.lvalue).to be_instance_of(TypedRb::Languages::PolyFeatherweightRuby::Model::TmInstanceVar)
      expect(parsed.lvalue.val).to be == :@a
      expect(parsed.rvalue).to be_instance_of(TypedRb::Languages::PolyFeatherweightRuby::Model::TmInt)
    end
  end
end
