...
describe TypedRb::Languages::PolyFeatherweightRuby::Model::TmLet do
  before :each do
...
__CODE
  ...
  context 'with simple assignment' do
    it 'should be possible to get the right type' do
      type = ast.check_type(TypedRb::Languages::PolyFeatherweightRuby::Types::TypingContext.top_level)
